...
assert_contains $'compare_summary\tsnapshot_id='"${symlink_snapshot_id}"$'\trepos_checked=1\tfiles_total=1\tresolved_committed=0\tresolved_uncommitted=0\tunresolved_missing=0\tunresolved_diverged=1\tunresolved_total=1\tshown_files=1\tengine=v3\telapsed_ms=' "${symlink_diverged_porcelain_output}" "porcelain summary should keep v5 counters for diverged symlink"
