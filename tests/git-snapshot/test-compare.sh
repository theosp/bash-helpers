...
assert_contains $'compare_summary\tsnapshot_id='"${progress_snapshot_id}"$'\trepos_checked=1\tfiles_total=1\tresolved_committed=0\tresolved_uncommitted=1\tunresolved_missing=0\tunresolved_diverged=0\tunresolved_total=0\tshown_files=1\tengine=v3\telapsed_ms=' "${compare_all_porcelain_output}" "compare porcelain summary should expose v5 status counters with v3 telemetry"
