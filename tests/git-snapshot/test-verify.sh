...
assert_contains "git-snapshot inspect ${second_snapshot_id} --repo . --staged --unstaged --untracked --name-only" "${verify_staged_output}" "follow-up guidance should include detailed inspect command"
